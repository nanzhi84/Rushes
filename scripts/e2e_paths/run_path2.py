...
def run_workflow(
    ...
    *,
    ...
    draft_id = unique_id("m9_path2_draft")
    stage_log("路径 2：创建草稿、导入 B-roll/图片")
    client.create_draft(
        draft_id=draft_id,
        name="M9 路径 2 TTS 种草",
    ...
    driver = DraftDriver(client=client, draft_id=draft_id, scenario="path2")
